"""
Django settings for VentToLife project.
...
SECRET_KEY = '5u1we(=_z)7#!sp#)h%nxq@7y1trcfb-r!um2flxilmufw-mga'
...
WSGI_APPLICATION = 'VentToLife.wsgi.application'
